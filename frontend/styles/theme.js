...
export const theme = createTheme({
  palette: {
    primary: {
      ...
      light: config.theme.primary.light,
      dark: config.theme.primary.dark,
    },
    secondary: {
      main: config.theme.secondary.main,
      light: config.theme.secondary.light,
      dark: config.theme.secondary.dark,
    },
    background: {
      default: '#f5f5f5',
      paper: '#ffffff',
